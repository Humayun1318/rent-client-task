    ...
    <>
      ...
      >
        <div className="space-y-4">
          <p className="font- border border-gray-300 rounded-xl p-4 max-w-3/6 w-full">
            Guest vheicle parking time{' '}
            <span className="border rounded-lg ml-6 px-6 py-2 border-gray-300">
              2h{' '}
            </span>
          </p>
          <textarea
